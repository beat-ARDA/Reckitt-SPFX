...
import { Client, FlowType } from '../../model/Common';
...
var PromoForm = /** @class */ (function (_super) {
                    ...
                    case 1:
                        ...
                        PromoService.GetViewModel(this.props.itemId).then(function (viewModel) {
                            ...
                            _this.setState(function (state, props) { return ({
                                ...
                                flowApproval: _this.state.viewModel.Entity.TipoFlujo == null && _this.state.viewModel.Entity.GetStatusId() == PromoStatus.Approval ? (approvers.Phase0Coordinator1.Value == _this.state.currentUser || approvers.Phase0Coordinator2.Value == _this.state.currentUser
                                    || approvers.Phase0Coordinator3.Value == _this.state.currentUser ? true : false) : false
                            }); });
                        }).catch(function (err) {
                            console.error(err);
    ...
    PromoForm.prototype.render = function () {
        ...
        if (!this.state.isLoading && !this.state.formSubmitted) {
            ...
            var flowType = this.state.viewModel.FlowsTypes != null ?
                this.state.viewModel.FlowsTypes.map(function (item) {
                    return { key: item.ItemId, text: item.Name };
                }) : [];
            //#endregion
            output =
                                                    ...
                                                    React.createElement(Stack, { grow: 8, className: "fixedStructure" },
                                                        ...
                                                        React.createElement(Stack, { horizontal: true, grow: 12, styles: { root: { paddingTop: "16px" } } },
                                                            ...
                                                            React.createElement(Stack, { className: "smallPadding fixedStructure", grow: 6 },
                                                                ...
                                                                React.createElement(Stack, { className: "padding-right controlPadding" }, !readOnlyForm ?
                                                                    React.createElement(Dropdown, { placeholder: "Seleccione una marca", label: "Marca:", options: brands, selectedKey: selectedItem.Brand ? selectedItem.Brand.ItemId : null, onChanged: this.onBrandChanged.bind(this), required: true, errorMessage: this.getValidationErrorMessage(selectedItem.Brand) }) :
                                    ...
                                    React.createElement(Stack, { grow: 2, className: "modalBottomButtonsContainer fixedStructure", horizontal: true, horizontalAlign: "end" },
                                        React.createElement(Stack, { grow: 6, className: "fixedStructure" },
                                            ...
                                            React.createElement(Dropdown, { style: {
                                                ...
                                                }, placeholder: "Selecciona un flujo", options: flowType, selectedKey: entity.TipoFlujo ? entity.TipoFlujo.ItemId : null, required: true, onChanged: this.onFlowChange.bind(this) }),
                                        ...
                                        React.createElement(Stack, { grow: 6, className: "fixedStructure" },
                                            ...
                                            React.createElement(PrimaryButton, { style: {
                                                    ...
                                                    backgroundColor: "#425C68",
                                                    border: "transparent"
                                                }, text: "Asignar flujo", allowDisabledFocus: true, onClick: this.flowAsign.bind(this) }),
                                            React.createElement(PrimaryButton, { style: {
    ...
    PromoForm.prototype.onFlowChange = function (item) {
        var _this = this;
        var flowtype = item.key;
        this.setState(function (state) {
            state.viewModel.Entity.TipoFlujo = new FlowType({ ItemId: flowtype, Name: item.text });
            return state;
        });
        this.setState(function (state) {
            state.viewModel.Entity.Items[_this.state.selectedIndex].FlowType = item.key ? new LookupValue({
                ItemId: item.key,
                Value: item.text
            }) : null;
            return state;
    ...
    PromoForm.prototype.flowAsign = function () {
        this.setState({
    ...
    PromoForm.prototype.confirmAction = function () {
        ...
        if (this.state.actionConfirmationDialogType == ActionConfirmationType.Approve) {
            ...
            PromoService.FlowAsign(this.state.viewModel.Entity, this.state.actionsComments, this.state.viewModel.Entity.TipoFlujo).then(function () {
                _this.setState({
                    formSubmitted: true,
                    resultIsOK: true
                });
