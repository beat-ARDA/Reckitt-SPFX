                    ...
                    case 1:
                        ...
                        PromoService.GetViewModel(this.props.itemId).then(function (viewModel) {
                            ...
                            _this.setState(function (state, props) { return ({
                                CopiarPromo: viewModel.Entity.Client && _this.state.currentUser ? (viewModel.Entity.Client.KeyAccountManager.Value == _this.state.currentUser ? true : false) : false //(viewModel.Entity.GetStatusText() == "Borrador" ? true : false)
                            }); });
                            ...
                            _this.setState(function (state, props) { return ({
                                ...
                                PromoProven: _this.state.viewModel.Entity.GetStatusId() == PromoStatus.Approved ? (approverss.Phase0Coordinator1.Value == _this.state.currentUser || approverss.Phase0Coordinator2.Value == _this.state.currentUser || approverss.Phase0Coordinator3.Value == _this.state.currentUser ? true : false) : false
                            }); });
                        }).catch(function (err) {
                            console.error(err);
