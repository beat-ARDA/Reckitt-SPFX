                    ...
                    case 1:
                        ...
                        PromoService.GetViewModel(this.props.itemId).then(function (viewModel) {
                            ...
                            _this.setState(function (state, props) { return ({
                                ...
                                flowApproval: viewModel.Entity.TipoFlujo == "" && approvers.Phase0Coordinator1.Value == _this.state.currentUser || approvers.Phase0Coordinator2.Value == _this.state.currentUser
                                    || approvers.Phase0Coordinator3.Value == _this.state.currentUser ? true : false
                            }); });
                        }).catch(function (err) {
                            console.error(err);
