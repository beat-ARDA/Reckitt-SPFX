...
var PromoForm = /** @class */ (function (_super) {
                    ...
                    case 1:
                        ...
                        PromoService.GetViewModel(this.props.itemId).then(function (viewModel) {
                            ...
                            _this.setState(function (state, props) { return ({
                                ...
                                flowApproval: viewModel.Entity.TipoFlujo == "" && _this.state.viewModel.Entity.GetStatusId() == PromoStatus.Approval ? (approvers.Phase0Coordinator1.Value == _this.state.currentUser || approvers.Phase0Coordinator2.Value == _this.state.currentUser
                                    || approvers.Phase0Coordinator3.Value == _this.state.currentUser ? true : false) : false,
                            }); });
                        }).catch(function (err) {
                            console.error(err);
                                    ...
                                    React.createElement(Stack, { grow: 2, className: "modalBottomButtonsContainer fixedStructure", horizontal: true, horizontalAlign: "end" },
                                        React.createElement(Stack, { grow: 6, className: "fixedStructure" },
                                            ...
                                            React.createElement(Dropdown, { style: {
                                                ...
                                                }, placeholder: "Selecciona un flujo", options: this.state.viewModel.FlowsTypes == undefined ? [] : this.state.viewModel.FlowsTypes, required: true, onChange: this.onFlowChange.bind(this) }),
    ...
    PromoForm.prototype.confirmAction = function () {
        ...
        if (this.state.actionConfirmationDialogType == ActionConfirmationType.Approve) {
            ...
            PromoService.FlowAsign(this.state.viewModel.Entity, this.state.actionsComments, "").then(function () {
                _this.setState({
                    formSubmitted: true,
                    resultIsOK: true
                });
