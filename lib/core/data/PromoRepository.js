...
var PromoRepository = /** @class */ (function () {
    ...
    PromoRepository.GetById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var item, items, client, _a, workflowLog, evidence;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, sp.web.lists.getByTitle(PromoRepository.LIST_NAME)
                            .items.getById(id).select("ID", "Title", "PromoName", "ActivityObjective", "ClientId", "StatusId", "SYS_WorkflowStages", "SYS_CurrentStageNumber", "Approvals", "TipoFlujo/Title").expand("TipoFlujo").get()];
                    case 1:
                        item = _b.sent();
                    ...
                    case 7:
                        evidence = _b.sent();
                        return [2 /*return*/, PromoRepository.BuildEntity(item, items, client, workflowLog, evidence)];
                }
            });
        });
    };
    ...
    PromoRepository.BuildEntity = function (item, items, client, workflowLog, evidence) {
        return __awaiter(this, void 0, void 0, function () {
            var entity, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
