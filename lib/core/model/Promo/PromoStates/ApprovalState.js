...
var ApprovalState = /** @class */ (function (_super) {
    ...
    ApprovalState.prototype.GetViewModel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var viewModel, currentUser, _a, puedeAprobar, indexUser, i;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        //     indexUser = -1;
                        // }
                        for (i = 0; i < viewModel.Entity.WorkflowStages[0].ApproverIDs.length; i++) {
    ...
    ApprovalState.prototype.FlowAsign = function (entity, comments, flowType) {
        return __awaiter(this, void 0, void 0, function () {
            var stage, user, kam, to, users, readerIDs, i, mensaje;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        _a.sent();
                        stage.AddToCompletBy(user.ItemId);
                        if (!stage.IsComplete()) return [3 /*break*/, 7];
                        if (!(entity.CurrentStageNumber == entity.WorkflowStages.length)) return [3 /*break*/, 4];
                        to = kam.Email;
                    ...
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, PromoRepository.SaveOrUpdate(entity, 1)];
                    case 9:
                        _a.sent();
