            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (!(this.Entity.CurrentStageNumber == this.Entity.WorkflowStages.length)) return [3 /*break*/, 4];
                        to = kam.Email;
                        NotificacionsManager.SendWorkflowApprovedNotification(this.Entity, to);
                        return [3 /*break*/, 7];
                    case 4:
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, WorkflowLogRepository.Save(this.Entity.ItemId, this.Entity.PromoID, mensaje, comments, this.Entity)];
                    case 10:
                        _a.sent();
                        return [2 /*return*/, NotificacionsManager.SendTaskApprovedNotification(this.Entity, user.Value, kam.Email)];
                }
