...
import { ClientRepository, PromoRepository, CategoryRepository, } from "../../../data";
...
var NewPromoState = /** @class */ (function (_super) {
    __extends(NewPromoState, _super);
    function NewPromoState() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NewPromoState.prototype.GetStatusId = function () {
        return PromoStatus.New;
    };
    NewPromoState.prototype.GetStatusText = function () {
        return Constants.StatusTexts.NewPromo;
    };
    NewPromoState.prototype.GetViewModel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var viewModel, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _b.Categories = _d.sent();
                        _c = viewModel;
                        return [4 /*yield*/, ClientProductRepository.GetAll()];
                    case 3:
                        _c.ClientProducts = _d.sent();
    ...
    NewPromoState.prototype.Save = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, entity.InitializeState()];
                }
            });
        });
    };
    NewPromoState.prototype.Submit = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return NewPromoState;
}(PromoState));
export { NewPromoState };
//# sourceMappingURL=NewPromoState.js.map