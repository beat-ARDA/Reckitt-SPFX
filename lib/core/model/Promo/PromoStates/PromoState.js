...
var PromoState = /** @class */ (function () {
    ...
    PromoState.prototype.FlowAsign = function (comments, flowType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
    ...
    PromoState.prototype.InitializeWorkflowState = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            var approvers, kamUserId, approverUserId, approver1, approver2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (entity.GetTotalEstimatedInvestment() > entity.Config.ApprovalAmountLimit) {
                            approver1 = approvers.Phase2Approver1.ItemId;
                            approver2 = approvers.Phase3Approver1.ItemId;
